...
EOF
    ...
    export LLVMUP_PREFIX="$TEST_TEMP_DIR/prefix"
    mkdir -p "$LLVMUP_PREFIX/bin" "$LLVMUP_PREFIX/share/bash-completion/completions" "$LLVMUP_PREFIX/share/zsh/site-functions"
    ...
    ! grep -q "LLVMUP Zsh Completion" "$TEST_PROFILE"
